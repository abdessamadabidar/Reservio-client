...
import DeleteAccountConfirmationDialog from "@/components/custom/delete-account-confirmation-dialog.tsx";
				...
				<div>
					<DropdownMenu>
						...
						<DropdownMenuContent align="end">
							...
							<DropdownMenuItem className="gap-x-2 text-red-500 focus:text-destructive dark:focus:text-red-600" onClick={toggleDialog}>
								<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
					...
					<DeleteAccountConfirmationDialog isOpen={isOpen} toggleOpen={toggleDialog} userId={id} />
				</div>
			</CardHeader>
				...
				<div className="grid space-y-4 gap-y-1">
					...
					<div className="text-sm col-span-1">
						<div className="flex items-center gap-x-2">
							...
							<span className="text-muted-foreground italic">{isApproved ? "Yes" : "No"}</span>
						</div>
