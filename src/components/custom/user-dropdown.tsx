...
export default function UserDropdown() {
	...
	return <DropdownMenu>
		...
		<DropdownMenuContent align="end">
			...
			<DropdownMenuItem >
				<Link to="change-password" className="flex items-center gap-x-1">
					<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
			...
			<DropdownMenuSeparator />
			<DropdownMenuItem className="flex items-center gap-x-1 text-destructive focus:text-destructive dark:text-red-600" onClick={logout}>
				<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
